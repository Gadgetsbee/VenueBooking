...
public partial class admin_attendance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            TextBox10.Text = Session["userid"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new SqlCommand("insert into tbl_services values('" + TextBox9.Text + "','" + TextBox3.Text + "','" + TextBox11.Text + "','" + DropDownList1.Text + "','" + Label2.Text + "','" + TextBox10.Text + "','" + TextBox2.Text + "')", con);
            cmd.ExecuteNonQuery();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new SqlCommand("update tbl_services set servicename='" + TextBox9.Text + "',description='" + TextBox3.Text + "',price='" + TextBox11.Text + "',category='" + DropDownList1.Text + "',photo='" + Label2.Text + "' where id='" + TextBox1.Text + "'", con);
            cmd.ExecuteNonQuery();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new SqlCommand("delete from tbl_services where id=" + TextBox1.Text + "", con);
            cmd.ExecuteNonQuery();
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new SqlCommand("SELECT * FROM tbl_services where id='" + a + "'", con);
            ...
            if (dr.Read())
            {
                ...
                Image1.ImageUrl = "upload/"+ dr[5].ToString();
            }
            con.Close();
        }
        catch (Exception er)
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        if (FileUpload1.PostedFile != null)
        {
            ...
            string str = Server.MapPath("upload/" + FileName);
